...
class MedicalResult(models.Model):
    ...
    prescription = models.TextField(verbose_name='Медицинское назначение', **settings.NULLABLE)
    comments = models.TextField(verbose_name='Комментарий', **settings.NULLABLE)
...
class MedicalResultFile(models.Model):
    ...
    file_description = models.CharField(max_length=50, verbose_name='Описание файла', **settings.NULLABLE)
    file = models.FileField(upload_to='medical_results/', **settings.NULLABLE)
